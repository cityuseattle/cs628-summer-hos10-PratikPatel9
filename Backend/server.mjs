...
const FACEBOOK_APP_ID = 850122756692915;
const FACEBOOK_APP_SECRET = '7b0cf00abff2d776455cd1f869c3b794';
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://orange-trout-65995pqw9vqcxv6q-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://orange-trout-65995pqw9vqcxv6q-5050.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://orange-trout-65995pqw9vqcxv6q-5050.app.github.dev', 
}));
